...
@section('content')
    ...
    <!-- Broadcasting Form -->
    <form action="{{ route('admin.scheduleMessage') }}" method="POST">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="datetime-local" name="scheduled_time" id="scheduled_time" class="block w-full mt-1 border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50 focus:ring-indigo-300">
        </div>

        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-lg">Schedule Message</button>
    </form>
