...
@section('content')
    <div class="container mx-auto">
        <div class="bg-white p-6 rounded-lg shadow-md mb-8">
            <p class="text-gray-700">Welcome to the Sub admin Dashboard. Here you can manage your application.</p>
        </div>
                            ...
                            <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                                ...
                                <td class="py-3 px-4 border-b text-gray-600 whitespace-nowrap">
                                    @if ($log->status === 'Pending')
                                        <form action="{{ route('subadmin.cancelScheduledMessage', $log->id) }}"
                                            method="POST">
                                            @csrf
